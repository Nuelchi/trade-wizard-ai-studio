...
import { ArrowRight, Copy, CheckCircle, Code, FileText, Brain, Sparkles } from "lucide-react";
          ...
          <div className="trading-card p-6">
            ...
            <Tabs defaultValue="pinescript" className="w-full">
              ...
              <TabsContent value="mql4" className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">MetaTrader 4 Expert Advisor</span>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <TabsContent value="mql5" className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">MetaTrader 5 Expert Advisor</span>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => copyToClipboard("// MQL5 code coming soon...", "MQL5")}
                    className="flex items-center space-x-2"
                  >
                    <Copy className="w-4 h-4" />
                    <span>Copy</span>
                ...
                <div className="code-block">
                  <pre className="text-sm">// MQL5 Expert Advisor code will be generated here...</pre>
                </div>
              </TabsContent>
            </Tabs>
          </div>
